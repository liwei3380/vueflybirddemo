var game = window.game = {
    ...
    initStage: function(dom){
        ...
        this.height = dom.clientHeight*2;
        this.scale = 0.5;
    ...
    initBackground: function(dom){
        //背景
        var bgWidth = this.width * this.scale;
        var bgHeight = this.height * this.scale;
        dom.insertBefore(Hilo.createElement('div', {
            id: 'bg',
            style: {
                background: 'url(http://www.liwei3380.xyz:8081/assets/bg.png) no-repeat',
